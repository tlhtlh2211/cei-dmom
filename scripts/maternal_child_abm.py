    ...
    def _initialize_agents(self):
        ...
        for i in range(num_women):
            ...
            attributes = AgentAttributes(
                ...
                distance_to_facility=np.random.exponential(3.0)  # Average 3km
            )
        ...
        for i in range(num_children):
            ...
            attributes = AgentAttributes(
                ...
                distance_to_facility=np.random.exponential(3.0)
            )
...
print("Complete ABM simulation framework loaded successfully!") 